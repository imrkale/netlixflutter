...
class _VideoDetailPageState extends State<VideoDetailPage> {
  int activeEpisode = 0;
  final youtube='https://www.youtube.com/watch?v=uz4xRnE-UIw.mp4';
  // for video player
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.network('https://assets.mixkit.co/videos/preview/mixkit-group-of-friends-partying-happily-4640-large.mp4')
      ..initialize().then((_) {
